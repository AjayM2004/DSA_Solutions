package tree.bt.implementation;
...
public class BinaryTree {
    ...
    private void populate(Scanner scanner, Node node) {
        ...
        if (left) {
            System.out.print("Enter the value of LEFT child of " + node.value + ": ");
            int value = scanner.nextInt();
        ...
        if (right) {
            System.out.print("Enter the value of RIGHT child of " + node.value + ": ");
            int value = scanner.nextInt();
